...
const SalesPerson = () => {
  ...
  // Update Payment ID
  const updatePaymentIdOld = async (e) => {
    e.preventDefault();
    setLoading(true);
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full md:w-[500px] min-h-[400px] max-h-[70vh] overflow-scroll scrollbar-hide bg-white py-8 pb-16 px-4 sm:px-6 border border-[#cfcfcf33] rounded-tl-lg rounded-tr-lg md:rounded-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="w-full grid gap-4 place-items-center grid-cols-1">
              ...
              <div className="w-full">
                ...
                <Select
                  ...
                  onChange={(selected) => setProjectPartnerId(selected.value)} // store only ID ✔
                />
              </div>
            </div>
            <div className="flex h-10 mt-8 md:mt-6 justify-center sm:justify-end gap-6">
